...
export const DoctorRegisterPage: React.FC = () => {
  ...
  // 6. Medical Registration Number
  if (!form.medicalRegNo.trim()) {
    errors.medicalRegNo = 'Medical registration number is required.';
  }

  // 7. Medical Qualification
  if (!form.qualification) {
    errors.qualification = 'Medical qualification is required.';
  ...
  // 15. Medical Certificate File
  if (!uploadedFile) {
    errors.file = 'Please upload your medical certificate.';
  ...
  // 17. Password Requirements Checks
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mt-2 max-w-md mx-auto">
                Your doctor registration has been successfully submitted to MediTwin AI.
              </p>
            </div>
            ...
            <div className="p-4 rounded-2xl bg-white/5 border border-white/10 text-xs text-gray-300 text-left space-y-2">
              ...
              <p>
                Your professional credentials are currently under review by the Hospital Administrator.
                Once verified, your workstation access will be activated.
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <div className="text-center space-y-2 max-w-2xl mx-auto">
              ...
              <p className="text-xs sm:text-sm text-gray-300">
                Register as a healthcare professional to securely access MediTwin AI.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8" noValidate>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5 md:col-span-2">
                    ...
                    <textarea
                      ...
                      value={form.address}
                      onChange={handleChange}
                      placeholder="Enter clinic, hospital suite, or residential address..."
              ...
              <div className="glass-card p-6 sm:p-8 border border-white/15 rounded-2xl space-y-6">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">Medical qualifications and clinical assignment</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleChange}
                        onBlur={() => handleBlur('medicalRegNo')}
                        placeholder="e.g. MCI-2024-88491"
                        className={`w-full py-3 px-4 bg-navy-900 border rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none transition-all ${
                    ...
                    {touched.medicalRegNo && errors.medicalRegNo && (
                      <p className="text-xs text-rose-400 flex items-center gap-1 mt-1">
                        <AlertCircle className="w-3.5 h-3.5" /> {errors.medicalRegNo}
                      </p>
                    )}
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <option value="MBBS" className="bg-navy-900">MBBS</option>
                      <option value="MD" className="bg-navy-900">MD</option>
                      <option value="MS" className="bg-navy-900">MS</option>
                      <option value="DNB" className="bg-navy-900">DNB</option>
                    ...
                    {form.qualification === 'Other' && (
                      <input
                        ...
                        placeholder="Specify Qualification (e.g. FRCS, DM)"
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <option value="Dermatology" className="bg-navy-900">Dermatology</option>
                      <option value="Psychiatry" className="bg-navy-900">Psychiatry</option>
                      <option value="Gynecology" className="bg-navy-900">Gynecology</option>
                      <option value="Other" className="bg-navy-900">Other</option>
                    </select>
                  </div>
              ...
              <div className="glass-card p-6 sm:p-8 border border-white/15 rounded-2xl space-y-6">
                <div className="flex items-center gap-3 border-b border-white/10 pb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-400">License verification and medical certificate upload</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  {/* Issuing Medical Council / Authority */}
                  <div className="space-y-1.5">
                    <label className="block text-xs font-semibold text-gray-300 uppercase tracking-wider">
                      Issuing Medical Council / Authority *
                    </label>
                  ...
                  {/* Drag and Drop Medical Certificate Upload */}
              ...
              <div className="glass-card p-6 sm:p-8 border border-white/15 rounded-2xl space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  ...
                  <div className="md:col-span-2 p-4 rounded-xl bg-white/5 border border-white/10 space-y-2 text-xs">
                    <p className="font-semibold text-gray-300 uppercase tracking-wider text-[11px]">
              ...
              <div className="glass-card p-6 sm:p-8 border border-white/15 rounded-2xl space-y-4">
                ...
                <div className="space-y-3 text-xs sm:text-sm text-gray-300">
                  <label className="flex items-start gap-3 cursor-pointer select-none">
                    ...
                    />
                    <span>
                      I confirm that the information provided is accurate and my medical credentials are currently valid and active.
                    </span>
                  </label>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-end gap-4 pt-4">
                ...
                >
                  {isSubmitting ? 'Submitting Credentials...' : 'Create Doctor Account'}
                </Button>
              </div>
            </form>
          </div>
