...
export const MOCK_PATIENTS: DoctorPatient[] = [
  {
    ...
    allergies: [
      ...
      },
      {
        ...
        notes: 'Seasonal allergy flare-ups.',
      },
    ],
    currentMedications: [
      { name: 'Amlodipine Besylate', dosage: '5 mg', frequency: 'Once daily (Morning)', startDate: '2026-08-10', prescribedBy: 'Dr. Sarah Joseph' },
    ...
    labReports: [
      ...
      { id: 'LAB-102', testName: 'Comprehensive Lipid Profile', date: '2026-06-15', result: '184', unit: 'mg/dL', referenceRange: '< 200', status: 'Normal', orderedBy: 'Dr. Sarah Joseph' },
    ],
    appointments: [
      { id: 'APT-101', date: '2026-08-10', time: '10:30', doctorName: 'Dr. Sarah Joseph', department: 'General Medicine', reason: 'Cardiology & Blood Pressure Review', status: 'Completed', notes: 'BP stable at 122/78 mmHg.' },
      { id: 'APT-102', date: '2026-09-15', time: '09:00', doctorName: 'Dr. Sarah Joseph', department: 'General Medicine', reason: 'Comprehensive Annual Preventive Health Checkup', status: 'Upcoming' },
    ],
    prescriptions: [
      { id: 'RX-101', date: '2026-08-10', doctorName: 'Dr. Sarah Joseph', notes: 'Mild Essential Hypertension — Take in morning', status: 'Active', medications: [{ name: 'Amlodipine Besylate', dosage: '5 mg', frequency: 'Once daily', startDate: '2026-08-10', prescribedBy: 'Dr. Sarah Joseph' }] },
    ],
    clinicalNotes: [
      { id: 'CN-101', date: '2026-08-10', time: '10:30 AM', authorName: 'Dr. Sarah Joseph', authorRole: 'Doctor', content: 'Comprehensive health evaluation completed. Blood pressure well-controlled.', type: 'Progress Note' },
    ],
    documents: [],
  },
  {
    ...
    currentMedications: [
      { name: 'Metformin Hydrochloride', dosage: '500 mg', frequency: 'Twice daily with meals', startDate: '2026-07-22', prescribedBy: 'Dr. Rahul Verma' },
    ...
    labReports: [
      ...
      { id: 'LAB-302', testName: 'Lipid Panel & LFT', date: '2026-07-22', result: '168', unit: 'mg/dL', referenceRange: '< 200', status: 'Normal', orderedBy: 'Dr. Rahul Verma' },
    ],
    appointments: [
      { id: 'APT-301', date: '2026-07-22', time: '11:00', doctorName: 'Dr. Rahul Verma', department: 'General Medicine', reason: 'Endocrinology & Diabetic Foot Examination', status: 'Completed' },
      { id: 'APT-302', date: '2026-10-20', time: '10:00', doctorName: 'Dr. Rahul Verma', department: 'General Medicine', reason: 'Routine 3-Month Diabetic Follow-up', status: 'Upcoming' },
    ],
    prescriptions: [
      { id: 'RX-301', date: '2026-07-22', doctorName: 'Dr. Rahul Verma', notes: 'Type 2 Diabetes Mellitus — Take with meals', status: 'Active', medications: [{ name: 'Metformin Hydrochloride', dosage: '500 mg', frequency: 'Twice daily', startDate: '2026-07-22', prescribedBy: 'Dr. Rahul Verma' }] },
    ],
    clinicalNotes: [
      { id: 'CN-301', date: '2026-07-22', time: '11:00 AM', authorName: 'Dr. Rahul Verma', authorRole: 'Doctor', content: 'Diabetic review normal. Pedal pulses strong.', type: 'Progress Note' },
    ],
    documents: [],
  },
  {
    ...
    allergies: [
      {
        ...
        reactionType: 'True IgE Allergy',
        notes: 'Strict contraindication for Aspirin/NSAIDs.',
      },
    ],
    currentMedications: [
      { name: 'Levothyroxine Sodium', dosage: '50 mcg', frequency: 'Once daily fasting', startDate: '2026-08-05', prescribedBy: 'Dr. Priya Sharma' },
    ...
    labReports: [
      ...
      { id: 'LAB-502', testName: 'Pulmonary Function Spirometry Report', date: '2026-05-18', result: '82', unit: '%', referenceRange: '> 75%', status: 'Normal', orderedBy: 'Dr. Priya Sharma' },
    ],
    appointments: [
      { id: 'APT-501', date: '2026-08-05', time: '14:00', doctorName: 'Dr. Priya Sharma', department: 'General Medicine', reason: 'Pulmonology & Respiratory Assessment', status: 'Completed' },
      { id: 'APT-502', date: '2026-11-10', time: '11:30', doctorName: 'Dr. Priya Sharma', department: 'General Medicine', reason: 'Endocrine & Thyroid Screening Follow-up', status: 'Upcoming' },
    ],
    prescriptions: [
      { id: 'RX-501', date: '2026-08-05', doctorName: 'Dr. Priya Sharma', notes: 'Hypothyroidism & Asthma management', status: 'Active', medications: [{ name: 'Levothyroxine Sodium', dosage: '50 mcg', frequency: 'Daily Fasting', startDate: '2026-08-05', prescribedBy: 'Dr. Priya Sharma' }] },
    ],
    clinicalNotes: [
      { id: 'CN-501', date: '2026-08-05', time: '02:00 PM', authorName: 'Dr. Priya Sharma', authorRole: 'Doctor', content: 'Lungs clear bilaterally. Thyroid status stable.', type: 'Progress Note' },
    ],
    documents: [],
  },
  {
